...
export const metadata: Metadata = {
  title: "Terms of Service | Boardverse",
  description: "Terms of Service for using Boardverse.",
};
    ...
    <main className={styles.page} lang="en">
      ...
      <article className={styles.document}>
        ...
        <p className={styles.lead}>
          These Terms of Service govern your access to and use of Boardverse, an online board game platform available at
          weplaytogether.online. By using Boardverse, you agree to these Terms.
        </p>

        <section>
          <h2>1. The Service</h2>
          <p>
            Boardverse lets users create, join, and play online board game rooms with friends and other players. Some
        ...
        <section>
          <h2>2. Eligibility</h2>
          <p>
            You must be able to form a legally binding agreement to use Boardverse. If you are under the age required by
        ...
        <section>
          ...
          <p>
            When you sign in with Google, you authorize Boardverse to use basic Google account information, such as your
        ...
        <section>
          ...
          <p>
            ...
            but you grant Boardverse a limited license to host, display, store, process, and transmit that content as
        ...
        <section>
          ...
          <p>You agree not to misuse Boardverse. Prohibited conduct includes:</p>
          <ul>
        ...
        <section>
          ...
          <p>
            ...
            delete information. By using Boardverse, you acknowledge that your information will be handled as described
        ...
        <section>
          ...
          <p>
            Boardverse may change, suspend, or discontinue features at any time. We may also update these Terms. When we
        ...
        <section>
          ...
          <p>
            Boardverse, including its interface, code, branding, and original assets, is owned by Boardverse or its
            licensors. These Terms do not grant you ownership of the service or permission to use Boardverse branding
        ...
        <section>
          <h2>9. Termination</h2>
          <p>
            We may suspend or terminate access to Boardverse if we believe you violated these Terms, created risk for
        ...
        <section>
          ...
          <p>
            Boardverse is provided on an &quot;as is&quot; and &quot;as available&quot; basis. To the maximum extent permitted by law, we do
        ...
        <section>
          ...
          <p>
            To the maximum extent permitted by law, Boardverse will not be liable for indirect, incidental, special,
