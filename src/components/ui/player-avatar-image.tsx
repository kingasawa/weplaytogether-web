...
type PlayerAvatarImageProps = Omit<ImageProps, "src" | "onError" | "unoptimized"> & {
  src: string;
  // avatarKey preset dùng làm ảnh mặc định để rơi về nếu src (Google/R2) load lỗi.
  avatarKey?: string | null;
};

// Avatar Google/R2 thỉnh thoảng hiện icon ảnh vỡ ngay sau khi đăng nhập rồi tự hết khi
